		...
		btn1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(ed2.getText().toString().trim().equals(ed3.getText().toString().trim())==false){
					...
					Toast.makeText(getApplicationContext(), "동일한비밀번호를입력해주세요", 1000).show();
				return;	
				}
				
				
				if(ed1.getText().toString().trim()!=null&&ed2.getText().toString().trim()!=null &&ed3.getText().toString().trim()!=null &&ed4.getText().toString().trim()!=null&&ed5.getText().toString().trim()!=null&&ed6.getText().toString().trim()!=null&&ed7.getText().toString().trim()!=null && !ed1.getText().toString().trim().equals("") && !ed2.getText().toString().trim().equals("")
						&& !ed3.getText().toString().trim().equals("")&& !ed4.getText().toString().trim().equals("")&& !ed5.getText().toString().trim().equals("")&& !ed6.getText().toString().trim().equals("")&& !ed7.getText().toString().trim().equals("")
			        && sex!=0 			){
			...
			try {
				...
				if(a.equals("1")){
					Toast.makeText(getApplicationContext(), "가입이 완료 되었습니다.", 1000).show();
					finish();
				}
			} catch (Exception e) {
